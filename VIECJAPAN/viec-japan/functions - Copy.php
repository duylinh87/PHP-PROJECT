...
function commonVariables () {
    ...
    if ($current_language == 'ja') {
        ...
        $var['vieclam_expired'] = 'Công việc đã hết hạn';
        ...
        $var['vieclam_related'] = 'Những đơn hàng cùng ngành nghề';
        $var['vieclam_viewed'] = 'Những đơn hàng xem nhiều';
...
function my_custom_lang() {
    ...
    if (ICL_LANGUAGE_CODE == 'vi') {
        echo
        '<style> .lang-vi {display:none !important;}</style>';
    }
    if (ICL_LANGUAGE_CODE == 'jp') {
        echo '<style> .lang-jp {display:none !important;}</style>';
    }
}
