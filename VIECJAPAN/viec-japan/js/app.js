...
//         $(this).next().slideToggle();
    ...
    $("#footer #menu-item-436,#menu-item-3467").on('click', function(e) {
        let url = "https://viecjapan.vn/vieclam/";
        window.location.replace(url);
    });
    $("#menu-item-286, #menu-item-436").on('click', function(e) {
        let url = "https://viecjapan.scvdev.webstarterz.com//vieclam/";
        window.location.replace(url);
    });
...
window.onload = function () {
    const SalaryCalculator = document.querySelector("#Salary-Calculator");
    const btnSalary = document.querySelector(".btnSalary ");
//const loading = document.querySelector('.loader');
    ...
    function calculateResults(e) {
        ...
        // const monthlyPayment = document.querySelector("#income-tax");
        // const totalInterest = document.querySelector("#heath-insurance");
        ...
        const total = (p - 13000 - 13000) * t * 12;
        let vnd = parseFloat(total * 207.38);
        const vndFomat = fomatMoney(vnd);
        const totalFomat = fomatMoney(total);

        if (isFinite(total)) {
            Salary.innerHTML = p + " Yen";
            totalAmount.innerHTML = totalFomat + " Yen" + " = " + vndFomat + " VNĐ";
            // hide loader
            btnSalary.classList.remove("loading");
            // show results
    ...
    function showError(error) {
        ...
        SalaryCalculator.insertBefore(errorMessage, calculate);
        // clear error
    ...
    btnSalary.addEventListener("click", (e) => {
        console.log("dsfdfsff")
        // show loader
        btnSalary.classList.add("loading");
        // set timeout
...
// 1 Thêm thời gian chờ và cho hiệu ứng loading rồi mới cho ra kếT quả
// 2  Ẩn kết quả khi nào có mới show ra
// 3 Thông báo lỗi khi chưa nhập số liệu
