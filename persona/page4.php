...
<head>
    ...
    <title>インターネット環境 | ペルソナ診断ツール</title>
        ...
        <div id="form04">
            <div class="form-main ">
                ...
                <div class="inner">
                    ...
                    <h3 id="title-page">“Aさん”はインターネットを使いますか？その利用具合を教えてください。</h3>
                        ...
                        <div class="box-form">
                            ...
                            <ul class="info-social">
                                ...
                                <li class="info-item flex">
                                    ...
                                    <div class="box-input flex">
                                        <div class="item-check-box flex">
                                            <input type="radio" name="internet" class="check-box" value="有" required="required" aria-required="true" id ="01">
                                            <label class="label-check-box" for="01">有</label>
                                        </div>
                                        <div class="item-check-box flex">
                                            <input type="radio" name="internet" class="check-box" value="無" required="required" aria-required="true" id ="02">
                                ...
                                <li class="info-item">
                                    ...
                                    <!-- ///---add check js-social yes or no -->
                                    <div class="box-input flex check-js">
                                        <div class="item-check-box flex">
                                            <input type="radio" name="check-js-social" class="check-box active-social" value="利用している" required="required" aria-required="true" id ="03">
                                            <label class="label-check-box" for="03">利用している</label>
                                        </div>
                                        <div class="item-check-box flex">
                                            <input type="radio" name="check-js-social" class="check-box no-social" value="利用していない" required="required" aria-required="true" checked  id ="04">
                                            <label class="label-check-box " for="04">利用していない</label>
                                        </div>
                                    </div>
                                ...
                                <li class="info-item">
                                    ...
                                    <div class="box-input flex check-js">
                                        <div class="item-check-box flex">
                                            <input type="radio" name="ratio-js-social" class="check-box active-radio" value="利用している" required="required" aria-required="true" id ="05">
                                            <label class="label-check-box" for="05">利用している</label>
                                        </div>
                                        <div class="item-check-box flex">
                                            <input type="radio" name="ratio-js-social" class="check-box no-radio" value="利用していない" required="required" aria-required="true" checked id ="06">
                                            <label class="label-check-box " for="06">利用していない</label>
                                        </div>
                                    </div>
