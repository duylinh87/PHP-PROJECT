            ...
            <div class="form-main ">
                ...
                <div class="inner">
                    ...
                    <div class="box-form">
                        ...
                        <p class="title-note">
                        最後にご入力いただいたご担当者様の情報のご入力をお願いいたします。<br>
入力完了後、結果のPDFがダウンロードできます。
                        </p>
                        <p class="title-note">                            
                        ...
                        <form id="frm07" action="complete.php" method="post">
                            <ul class="info-social">
                                ...
                                <li class="info-item">
                                    ...
                                    <div class="box-tarea">
                                        <input type="text" name="location" class="texa-01" required="required" aria-required="true">
                                    </div>
                                </li>
                                <li class="info-item">
    ...
    oninput="validateEmail(document.getElementById('email'), this);" required="required" aria-required="true">
                            ...
                            <div class="link-box">
                                <input type="submit" name="next" class="link" value="結果を見る">
                                <p class="submit-note text-red">※「結果を見る」ボタンを押すと、結果のPDFがダウンロードできます。</p>
                            </div>
                        </form>
                    </div>        
                </div>
